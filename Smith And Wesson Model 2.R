...
#Run Tests on Data
  ...
  bestrmse(Stock.mean.Train,SmallerStock.mean.test,p=c(0:7),d=c(1),q=c(0:3))
...
#Build Arima for transformed and not transformed
  ...
  adf.test(fit.stock.train$residuals);kpss.test(fit.stock.train$residuals) #Stationarity residual test
